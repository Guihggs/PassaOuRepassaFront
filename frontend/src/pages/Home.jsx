...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 px-6 text-center">
      <div>
        <img
          src="/logo-semana-dema.png"
          alt="Semana Demá PR²"
          className="w-40 md:w-52 mx-auto mb-4 drop-shadow-[0_0_25px_rgba(220,30,42,0.35)]"
        />
        <p className="uppercase tracking-[0.3em] text-cyan text-sm font-semibold mb-2">Quiz das Equipes</p>
        <h1 className="font-display text-4xl md:text-5xl font-bold">Escolha uma tela</h1>
      </div>
