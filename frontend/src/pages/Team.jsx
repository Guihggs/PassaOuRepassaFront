...
const COLOR_OPTIONS = [
  { name: "Azul", value: "#0D3F94" },
  { name: "Vermelho", value: "#DC1E2A" },
  { name: "Verde", value: "#10B981" },
  { name: "Amarelo", value: "#F4C10F" },
  { name: "Roxo", value: "#8B5CF6" },
  { name: "Rosa", value: "#FF4D6D" },
];
      ...
      <FullScreen>
        <div className="w-full max-w-sm space-y-6">
          ...
          <button
            ...
            disabled={!name.trim()}
            className="w-full rounded-xl bg-volt text-white font-display font-semibold text-lg py-4 disabled:opacity-30"
          >
